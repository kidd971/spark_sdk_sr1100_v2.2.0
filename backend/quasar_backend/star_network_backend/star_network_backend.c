...
facade_certification_mode_t facade_get_certification_mode(void)
{
    ...
    return FACADE_CERTIF_STAR_NETWORK;
}
...
{
    /* The button uses by the Node to transmits a button state to the Coord is the second (SW2) button on the board. */
    return quasar_button_read_state(QUASAR_BUTTON_USER_2);
}

bool facade_coord_read_user_button_1_state(void)
{
    /* The button uses by the Coord to transmits a button state to Node 1 is the third (SW3) button on the board. */
    return quasar_button_read_state(QUASAR_BUTTON_USER_3);
}

bool facade_coord_read_user_button_2_state(void)
{
    /* The button uses by the Coord to transmits a button state to Node 2 is the fourth (SW4) button on the board. */
    return quasar_button_read_state(QUASAR_BUTTON_USER_4);
}
