/** @file  datalink_facade.h
 *  @brief Facades for low-level platform-specific features required by the application example.
 *
 *  @note This header defines the interfaces for various hardware features used by the datalink example.
 *
 ...
 */
#ifndef DATALINK_FACADE_H_
#define DATALINK_FACADE_H_
